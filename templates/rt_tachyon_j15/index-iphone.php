		...
		<div id="rt-page-surround">
			...
			<div id="rt-page-background">
				<div id="rt-header-surround" <?php echo $gantry->displayClassesByTag('rt-header-surround');?>>
					<div id="rt-header-background" <?php echo $gantry->displayClassesByTag('rt-header-background');?>>
				...
				<div id="rt-body-background">
					<div class="rt-container">
						...
						<?php /** Begin Main Body **/ ?>
						<div id="rt-main" <?php echo $gantry->displayClassesByTag('rt-body-surround'); ?>><div id="rt-main-inner">
