...
}if(!this.textarea){throw new Error('Original textarea "'+b.textarea+'" not found in the DOM.');}this.editor=ace.edit(this.container);this.insert(this.textarea.get("value"));
...
}.bind(this));document.id(this.editor.renderer.scroller).addEvent("scroll",function(){var d=this.editor.renderer,e=d.$gutter,c=d.scroller,f=c.scrollLeft;
