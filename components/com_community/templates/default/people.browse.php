	...
	<!-- Slider Kit compatibility -->
		...
		<div id="cFeatured">
			...
			<div class="cFeaturedFriends">
				<a class="cFeaturedCover group-link" href="<?php echo CRoute::_('index.php?option=com_community&view=profile&userid=' . $firstuser->id );?>" id="group-link">
				...
				<div class="album-actions">
					<a class="album-action remove-featured" title="<?php echo JText::_('COM_COMMUNITY_REMOVE_FEATURED'); ?>" onclick="joms.featured.remove('<?php echo $firstuser->id;?>','search');" href="javascript:void(0);"><?php echo JText::_('COM_COMMUNITY_REMOVE_FEATURED'); ?></a>
				</div>
				<?php } ?>
