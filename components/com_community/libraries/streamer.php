...
if($joomla_ver >= '0.25')
{
	require_once( JPATH_LIBRARIES.DS.'joomla'.DS.'string'.DS.'string.php' );
	require_once( JPATH_LIBRARIES.DS.'joomla'.DS.'filesystem'.DS.'path.php' );
...
else
{
	...
	$post_string = JRequest::getVar('target', 0);
}
